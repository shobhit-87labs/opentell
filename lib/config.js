...
function loadConfig() {
  ...
  // Back-fill multi-provider fields
  if (!raw.llm_provider) raw.llm_provider = "anthropic";
  if (raw.llm_base_url === undefined) raw.llm_base_url = "";
  if (raw.llm_api_key === undefined) raw.llm_api_key = "";
  return raw;
}
